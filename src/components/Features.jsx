...
function Features() {
  ...
  return (
    <div className='container mx-auto py-6'>
        <div className='grid grid-cols-3'>{features.map((item,index)=>(
            
<div className='border border-gray-500 p-5 text-center'key={item.title}>
    <FontAwesomeIcon className='text-blue-500 text-4xl' icon={item.icon}/>
