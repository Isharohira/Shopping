      ...
      <div className="grid grid-cols-4 gap-6 grid-rows-2">
        ...
        <div className="col-span-2 row-span-2">
          <div className=" relative overflow-hidden">
            <img
              className="w-full h-full object-cover hover:scale-110 transition-all transform-ease-in-out delay-200"
              src={largeImage} alt="men image"
            />
<button className="absolute inset-0 text-white text-lg w-full h-full opacity-0  hover:opacity-100 transition-opacity ease-linear delay-200 bg-black bg-opacity-50">View Details</button>
